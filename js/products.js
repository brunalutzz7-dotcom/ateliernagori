...
const PRODUCTS = [
  ...
  { id: "bonsai-shimpaku-5", nome: "Bonsai Shimpaku · 4 anos", especie: "Juniperus chinensis 'Shimpaku' · aprox. 30 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Quatro anos de condução num tronco já curvado, de casca fina e folhagem escamosa verde-clara. O junípero clássico dos jardins japoneses, no ponto em que ainda se deixa moldar — para acompanhar a árvore ganhar forma.", preco: 600, img: IMG("bonsai-shimpaku-5") },

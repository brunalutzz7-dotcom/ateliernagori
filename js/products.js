...
const PRODUCTS = [
  ...
  { id: "maranta-pavao", nome: "Maranta Pavão", especie: "Calathea makoyana", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Desenho de pena em cada folha, translúcido contra a luz. Fecha as folhas à noite e as reabre pela manhã. Gosta de luz indireta e de ar úmido.", preco: 220, img: IMG("maranta-pavao") },
  ...
  { id: "aveloz-palito-fogo", nome: "Aveloz Palito de Fogo", especie: "Euphorbia tirucalli 'Rosea'", categoria: "arlivre", ambiente: "externo", pet: "toxic",
    descricao: "Hastes cilíndricas sem folha, que passam de verde a laranja e coral conforme pegam sol. Escultura viva, e das que menos pedem água.", preco: 250, img: IMG("aveloz-palito-fogo") },

...
const PRODUCTS = [
  ...
  { id: "aglaonema", nome: "Aglaonema", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhagem de cores vivas o ano todo, sem depender de flor — do vermelho ao rosa, branco e tricolor. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", variantes: [{ label: "Vermelha", preco: 230 }, { label: "Rosa", preco: 230 }, { label: "Pink", preco: 230 }, { label: "Branca", preco: 230 }, { label: "Branca Rosada", preco: 230 }, { label: "Tricolor", preco: 230 }, { label: "Cherry", preco: 230 }], imgs: [IMG("aglaonema-vermelha"), IMG("aglaonema-rosa"), IMG("aglaonema-pink"), IMG("aglaonema-branca"), IMG("aglaonema-branca-rosada"), IMG("aglaonema-tricolor"), IMG("aglaonema-cherry")] },

...
const PRODUCTS = [
  ...
  { id: "aglaonema-cherry", nome: "Aglaonema Cherry", especie: "Aglaonema commutatum 'Cherry'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas salpicadas de rosa-cereja sobre o verde, cada uma com um desenho único. A aglaonema mais desejada — cor viva o ano todo, sem depender de flor.", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", preco: 270, img: IMG("aglaonema-cherry") },
  { id: "aglaonema-vermelha", nome: "Aglaonema Vermelha", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhagem de vermelho intenso sobre o verde, cor viva o ano inteiro sem depender de flor. Fácil de cuidar, gosta de luz indireta.", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", preco: 230, img: IMG("aglaonema-vermelha") },
  { id: "aglaonema-branca-rosada", nome: "Aglaonema Rosa", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas em tons de rosa e verde, cor o ano todo sem depender de flor. Fácil de cuidar, gosta de luz indireta.", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", preco: 230, img: IMG("aglaonema-branca-rosada") },
  { id: "aglaonema-rosa", nome: "Aglaonema Lima", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhagem verde-limão clara e luminosa, cor o ano todo sem depender de flor. Fácil de cuidar, gosta de luz indireta.", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", preco: 230, img: IMG("aglaonema-rosa") },
  { id: "aglaonema-branca", nome: "Aglaonema Branca", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas quase totalmente creme salpicadas de verde — delicada e luminosa. Cor o ano todo sem depender de flor, gosta de luz indireta.", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", preco: 230, img: IMG("aglaonema-branca") },
  { id: "maranta-triostar-grande", nome: "Maranta Triostar", especie: "Stromanthe sanguinea 'Triostar'", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "A Triostar em tamanho cheio: folhas longas pintadas de verde, creme e rosa, com o verso magenta vibrante. Uma folhagem de presença, das mais desejadas.", significado: "Planta da oração — ergue e baixa as folhas como em prece. Símbolo de gratidão e proteção do lar.", preco: 245, img: IMG("maranta-triostar-grande") },
  { id: "maranta-triostar", nome: "Mini Maranta Triostar", especie: "Stromanthe sanguinea 'Triostar'", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Verde, creme e rosa na mesma folha, com verso inteiramente magenta. Levanta as folhas à noite e as baixa pela manhã.", significado: "Planta da oração — ergue e baixa as folhas como em prece. Símbolo de gratidão e proteção do lar.", preco: 150, img: IMG("maranta-triostar") },
  { id: "maranta-cascavel-grande", nome: "Maranta Cascavel", especie: "Goeppertia lancifolia", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folhas longas e onduladas com o desenho de manchas escuras que lembra pele de cobra, e o verso vinho. Tamanho cheio, cheia de folhas — uma das marantas mais marcantes.", significado: "Planta da oração: fecha as folhas à noite. Símbolo de gratidão, calma e proteção.", preco: 230, img: IMG("maranta-cascavel-grande") },
  { id: "maranta-cascavel", nome: "Mini Maranta Cascavel", especie: "Goeppertia insignis", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folha estreita e ondulada, salpicada de manchas escuras alternadas — o nome vem do desenho, que lembra pele de cobra.", significado: "Planta da oração: fecha as folhas à noite. Símbolo de gratidão, calma e proteção.", preco: 150, img: IMG("maranta-cascavel") },
  { id: "singonio", nome: "Singônio Rosa", especie: "Syngonium podophyllum", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folha em ponta de flecha que muda de forma conforme a planta amadurece.", significado: "Símbolo de renovação e crescimento — dizem que atrai energia positiva para os novos começos.", preco: 250, img: IMG("singonio") },
  { id: "singonio-estrelado", nome: "Singônio Estrelado", especie: "Syngonium podophyllum", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas recortadas em ponta de estrela, que mudam de forma conforme a planta cresce. Compacto e cheio.", significado: "Símbolo de renovação e de novos ciclos — atrai energia positiva e leveza para a casa.", preco: 250, img: IMG("singonio-estrelado") },
  ...
  { id: "jiboia-suspensa", nome: "Jiboia Suspensa", especie: "Epipremnum aureum · pendente", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas em coração, variegadas de verde e creme, que caem livres da esfera. Perfeita para prateleira alta ou suporte de gancho.", significado: "Conhecida como planta do dinheiro no oriente — símbolo de prosperidade, e ainda purifica o ar." , preco: 270, img: IMG("jiboia-suspensa") },
  { id: "mini-jiboia", nome: "Mini Jiboia", especie: "Epipremnum aureum · mini", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "A jiboia em versão pequena, de folhas coração. Resistente e fácil de cuidar — cresce em cascata conforme se acostuma com o cantinho. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", significado: "Conhecida como planta do dinheiro — símbolo de prosperidade e purificação, boa sorte fácil de cuidar.", preco: 150, variantes: [{ label: "Jade", preco: 150 }, { label: "Filodendro Brasil", preco: 150 }, { label: "Marmorizada", preco: 150 }, { label: "Prateada", preco: 150 }, { label: "Pérola", preco: 150 }], imgs: [IMG("mini-jiboia-3"), IMG("filodendro-brasil"), IMG("mini-jiboia-2"), IMG("mini-jiboia-4"), IMG("mini-jiboia-5")] },
  { id: "hera-estrelada", nome: "Hera Estrelada", especie: "Hedera helix", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Folhas recortadas em estrela que descem em cascata. Linda em suporte alto ou pendente, deixando as pontas caírem.", significado: "A hera simboliza laços eternos, fidelidade e amizade que perdura — presente de quem fica junto.", preco: 180, img: IMG("hera-estrelada") },
  ...
  { id: "costela-adao-constellation", nome: "Costela de Adão Constellation", especie: "Monstera deliciosa 'Thai Constellation'", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "A variegada mais desejada: folhas grandes salpicadas de creme, cada uma um desenho único. Peça de colecionador.", significado: "Símbolo de longevidade e prosperidade — cada nova folha aberta representa crescimento e boas oportunidades.", preco: 490, img: IMG("costela-adao-constellation") },
  { id: "mini-costela-adao", nome: "Mini Costela de Adão", especie: "Monstera deliciosa · mini", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "A costela de Adão em tamanho de mesa, com os recortes que todo mundo ama já começando a aparecer.", significado: "Símbolo de longevidade e prosperidade — cada nova folha aberta representa crescimento e boas oportunidades.", preco: 175, img: IMG("mini-costela-adao") },
  { id: "alocasia-polly", nome: "Alocásia Polly", peso: 3, especie: "Alocasia × amazonica", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folha em ponta de flecha, verde quase preto com nervura branca em relevo. Desenho gráfico, quase artificial de tão marcado.", significado: "Símbolo de boas-vindas e proteção do lar — suas folhas em flecha representam caminhos que se abrem.", preco: 215, img: IMG("alocasia-polly") },
  { id: "pata-de-elefante", nome: "Mini Pata de Elefante", peso: 3, especie: "Beaucarnea recurvata", categoria: "ambos", ambiente: "ambos", pet: "safe",
    descricao: "Base inchada que guarda água, folhas finas em cascata. Esquece a rega e ela não sente.", significado: "Guarda água no tronco — símbolo de resiliência, longevidade e prosperidade que se acumula com o tempo.", preco: 250, img: IMG("pata-de-elefante") },
  { id: "pacova", nome: "Pacová", peso: 3, especie: "Philodendron martianum", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Folha inteira e grossa sobre pecíolo inflado. Forma limpa, quase escultórica.", significado: "Da família dos filodendros — símbolo de saúde, força e abundância, o verde que traz bem-estar ao ambiente.", preco: 290, img: IMG("pacova") },
  { id: "pachira-aquatica", nome: "Pachira · Árvore do Dinheiro", peso: 3, especie: "Pachira aquatica · a árvore do dinheiro", categoria: "ambos", ambiente: "ambos", pet: "safe",
    descricao: "Tronco trançado à mão e folhas em leque no topo. É a famosa árvore do dinheiro — dizem que atrai prosperidade, e é por isso que sai tanto como presente.", significado: "A famosa árvore do dinheiro — símbolo de prosperidade, fortuna e boa sorte. O presente clássico para atrair abundância para a casa.", preco: 230, img: IMG("pachira-aquatica") },
  { id: "mini-arvore-felicidade", nome: "Árvore da Felicidade", especie: "Polyscias sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Árvore da felicidade em tamanho médio. Tronco lenhoso e folhagem recortada — dizem que atrai boas energias, e é por isso que sai tanto como presente.", significado: "A árvore da felicidade — símbolo de boas energias, harmonia e alegria no lar.", preco: 300, img: IMG("mini-arvore-felicidade") },
  { id: "ficus-shivereana", nome: "Fícus Elástica Shivereana", peso: 3, especie: "Ficus elastica 'Shivereana'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Borracha variegada de folhas grandes salpicadas de verde e creme, cada uma diferente. Lustrosa e cheia de presença, gosta de luz indireta.", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", preco: 390, img: IMG("ficus-shivereana") },
  { id: "ficus-lyrata", nome: "Fícus Lyrata", peso: 3, especie: "Ficus lyrata", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "A folha-de-lira: folhas grandes em forma de violino, com nervuras marcadas. Porte escultural que enche o ambiente. Gosta de luz clara indireta.", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", preco: 350, img: IMG("ficus-lyrata") },
  { id: "ficus-burgundy", nome: "Fícus Elástica Burgundy", peso: 3, especie: "Ficus elastica 'Burgundy'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Borracha de folhas grandes verde-escuras com brilho vinho, quase pretas na luz. Elegante e fácil de cuidar.", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", preco: 390, img: IMG("ficus-burgundy") },
  { id: "ficus-tineke", nome: "Fícus Elástica Tineke", peso: 3, especie: "Ficus elastica 'Tineke'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Borracha variegada de creme, verde e rosa nas folhas novas, cada uma única. Lustrosa e cheia de charme, gosta de luz indireta.", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", preco: 390, img: IMG("ficus-tineke") },
  { id: "ficus-ruby", nome: "Fícus Elástica Ruby", peso: 3, especie: "Ficus elastica 'Ruby'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Borracha variegada de tons rosados e vinho sobre o verde, cada folha um desenho. Quanto mais luz filtrada, mais o rosa aparece.", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", preco: 390, img: IMG("ficus-ruby") },
  ...
  { id: "asplenio", nome: "Asplênio", peso: 3, especie: "Asplenium nidus", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folhas inteiras em roseta, brilhantes. Cresce como um ninho aberto sobre a esfera.", significado: "A samambaia-ninho simboliza proteção, aconchego e a força tranquila de um novo ninho.", preco: 280, img: IMG("asplenio") },
  { id: "anturio-rosa", nome: "Antúrio Rosa", especie: "Anthurium andraeanum · tamanho médio", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Espata rosada e brilhante que dura semanas abertas, sobre folhagem verde-escura lustrosa. Floresce quase o ano todo em luz indireta.", significado: "O antúrio simboliza hospitalidade, abundância e um amor caloroso — de coração aberto para quem chega.", preco: 275, img: IMG("anturio-rosa") },
  { id: "anturio-coracao", nome: "Antúrio Coração", especie: "Anthurium clarinervium", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas grandes em forma de coração, aveludadas e verde-escuras, com nervuras brancas bem marcadas. Uma folhagem de colecionador — pede luz indireta e umidade.", significado: "Suas folhas em coração são símbolo de amor, hospitalidade e afeto cultivado com carinho.", preco: 230, img: IMG("anturio-coracao") },
  { id: "aspargo-melindre", nome: "Aspargo Melindre", especie: "Asparagus setaceus", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "Ramos horizontais em camadas finíssimas, quase gráficos. Parece desenho a nanquim.", significado: "Símbolo de leveza e renovação — folhagem delicada que traz frescor e bons ares ao ambiente.", preco: 230, img: IMG("aspargo-melindre") },
  { id: "avenca", nome: "Avenca", especie: "Adiantum sp.", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Frondes delicadas de folíolos miúdos, verde vivo. Adora umidade — ótima em banheiro claro ou pertinho de outras plantas.", significado: "A avenca simboliza delicadeza, sinceridade e a beleza discreta — presente de carinho verdadeiro.", preco: 230, img: IMG("avenca") },
  ...
  { id: "bonsai-serissa-8", nome: "Bonsai Serissa · 8 a 9 anos", especie: "Serissa japonica · 20 a 30 cm", categoria: "bonsai", ambiente: "ambos", pet: "toxic",
    descricao: "Conhecida como árvore das mil estrelas — cobre-se de flores brancas miúdas em ondas sucessivas. Tronco claro e retorcido.", significado: "A serissa, 'árvore das mil estrelas', simboliza renascimento e a beleza dos pequenos recomeços.", preco: 800, img: IMG("bonsai-serissa-8") },
  { id: "bonsai-ficus-6", nome: "Bonsai Fícus · 6 anos", especie: "Ficus microcarpa · aprox. 30 cm", categoria: "bonsai", ambiente: "interno", pet: "toxic",
    descricao: "Seis anos num fícus de raízes engrossadas que emergem da esfera como um pequeno tronco de várias pernas. Folha pequena, lustrosa e verde-escura, copa densa. O bonsai de interior mais generoso — aceita luz indireta e perdoa esquecimento.", significado: "Fícus em bonsai — símbolo de abundância, unidade e prosperidade duradoura.", preco: 800, img: IMG("bonsai-ficus-6") },
  { id: "bonsai-jabuticabeira-12", nome: "Bonsai Jabuticabeira · 16 anos", especie: "Plinia cauliflora · aprox. 50 cm · frutificando", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos de formação, e já frutifica. A jabuticaba nasce colada ao tronco, como na árvore inteira — só que em meio metro de altura.", significado: "A jabuticabeira simboliza fartura, raízes e paciência — a árvore de quem valoriza o tempo.", preco: 2500, imgs: [IMG("bonsai-jabuticabeira-12-2"), IMG("bonsai-jabuticabeira-12-3"), IMG("bonsai-jabuticabeira-12-4")] },
  { id: "bonsai-jabuticabeira-4", nome: "Bonsai Jabuticabeira · 4 anos", especie: "Plinia cauliflora · aprox. 40 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Casca lisa e clara, folhagem miúda, estrutura ainda em desenho. A peça de quem quer acompanhar a árvore desde cedo.", significado: "A jabuticabeira simboliza fartura, raízes e paciência — a árvore de quem valoriza o tempo.", preco: 800, img: IMG("bonsai-jabuticabeira-4") },
  { id: "bonsai-amora-17", nome: "Bonsai Amora · 16 anos", especie: "Morus nigra · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos em meio metro. Tronco engrossado, casca fissurada, e fruta escura na estação — árvore que dá colheita numa mesa de sala.", significado: "A amoreira simboliza sabedoria, fartura e a doçura da vida colhida com paciência.", preco: 2000, img: IMG("bonsai-amora-17") },
  { id: "bonsai-amora-7", nome: "Bonsai Amora · 7 anos", especie: "Morus nigra · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Mesma altura da irmã mais velha, dez anos a menos de tronco. Cresce rápido e responde bem à poda — boa para quem quer aprender a conduzir.", significado: "A amoreira simboliza sabedoria, fartura e a doçura da vida colhida com paciência.", preco: 800, img: IMG("bonsai-amora-7") },
  { id: "bonsai-oliveira-16", nome: "Bonsai Oliveira · 16 anos", especie: "Olea europaea · aprox. 40 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos de condução em um tronco que já carrega casca rugosa e curva definida. Folha prateada que troca de tom conforme a luz atravessa o dia.", significado: "A oliveira é símbolo universal de paz, sabedoria e prosperidade — a árvore da longevidade.", preco: 2500, img: IMG("bonsai-oliveira-16") },
  { id: "bonsai-pinheiro-negro-14", nome: "Bonsai Pinheiro Negro · 14 anos", especie: "Pinus thunbergii · 40 a 60 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "A espécie mais reverenciada da tradição japonesa. Agulha rígida, casca em placas, silhueta construída agulha por agulha ao longo de catorze anos.", significado: "O pinheiro simboliza longevidade, força e imortalidade — a árvore mais reverenciada da tradição japonesa.", preco: 3000, img: IMG("bonsai-pinheiro-negro-14") },
  { id: "bonsai-shimpaku-16", nome: "Bonsai Shimpaku · 16 anos", especie: "Juniperus chinensis 'Shimpaku' · 30 a 40 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Junípero de folha escamosa e macia, madeira que aceita torção. O clássico dos jardins japoneses, em escala de mesa.", significado: "O junípero simboliza proteção, purificação e vida longa — guardião dos jardins japoneses.", preco: 2300, img: IMG("bonsai-shimpaku-16") },
  { id: "bonsai-shimpaku-5", nome: "Bonsai Shimpaku · 4 anos", especie: "Juniperus chinensis 'Shimpaku' · aprox. 30 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Quatro anos de condução num tronco já curvado, de casca fina e folhagem escamosa verde-clara. O junípero clássico dos jardins japoneses, no ponto em que ainda se deixa moldar — para acompanhar a árvore ganhar forma.", significado: "O junípero simboliza proteção, purificação e vida longa — guardião dos jardins japoneses.", preco: 800, img: IMG("bonsai-shimpaku-5") },
  { id: "bonsai-sakura", nome: "Bonsai Sakura", especie: "Prunus serrulata · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "A cerejeira japonesa em vinte centímetros. Floresce antes de folhar, e a flor dura poucos dias — é a imagem exata de nagori.", significado: "A cerejeira simboliza a beleza efêmera da vida — viver intensamente o instante que passa.", preco: 990, img: IMG("bonsai-sakura") },
  { id: "bonsai-caliandra-9", nome: "Bonsai Caliandra Rosa · 9 anos", especie: "Calliandra brevipes · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Tronco engrossado, casca rugosa e ramificação já aberta. Flor em pompom rosado quase o ano inteiro.", significado: "A caliandra, de flor em pompom, simboliza afeto, delicadeza e alegria que se renova.", preco: 1000, img: IMG("bonsai-caliandra-9") },
  { id: "bonsai-jasmim-anao-6", nome: "Bonsai Jasmim Anão · 6 anos", especie: "Jasminum sp. · anão · aprox. 30 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Seis anos de condução num tronco que já engrossou, criou casca e recebeu líquen. Floresce branco ao entardecer e perfuma um ambiente inteiro. Espécie difícil de encontrar já formada.", significado: "O jasmim simboliza amor puro, doçura e boas energias — seu perfume traz paz ao lar.", preco: 800, img: IMG("bonsai-jasmim-anao-6") },
  { id: "bonsai-buxus-9", nome: "Bonsai Buxus · 9 anos", especie: "Buxus harlandii · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Folha pequena e coriácea, casca cortiçosa e clara. Aceita poda severa e mantém a forma por muito tempo.", significado: "O buxinho simboliza permanência e proteção — cultivado há séculos como guardião de jardins.", preco: 900, img: IMG("bonsai-buxus-9") },
  { id: "bonsai-cerejeira-rg-6", nome: "Bonsai Cerejeira-do-Rio-Grande · 7 anos", especie: "Eugenia involucrata · 30 a 40 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Nativa da mata atlântica, prima da jabuticabeira. Folha miúda e lustrosa. Dá flores brancas de estames finos e frutos vermelho-escuros comestíveis, de sabor doce — colheita numa árvore de mesa.", significado: "Nativa da mata atlântica — símbolo de raízes, fartura e pertencimento à terra.", preco: 800, img: IMG("bonsai-cerejeira-rg-6") },
  { id: "bonsai-cambui-8", nome: "Bonsai Cambuí · 8 anos", especie: "Myrciaria tenella · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Nativa da mata atlântica, de folha minúscula e casca clara que descama sozinha. Dá frutinha vermelha comestível.", significado: "Nativa que dá fruto — símbolo de fartura, raízes brasileiras e a doçura das coisas simples.", preco: 990, img: IMG("bonsai-cambui-8") },
  ...
  { id: "oliveira-grande", nome: "Oliveira", especie: "Olea europaea · 1,60 m a 1,80 m", categoria: "grande", ambiente: "externo", pet: "safe",
    descricao: "Oliveira adulta sustentada por uma única esfera de musgo. Tronco e folha prateada em escala de árvore — peça de chão, para hall e canto de sala.", significado: "A oliveira é símbolo universal de paz, sabedoria e prosperidade — a árvore da longevidade.", preco: 2500, img: IMG("oliveira-grande") },
  { id: "jabuticabeira-grande", nome: "Jabuticabeira", especie: "Plinia cauliflora · 1,20 m a 1,60 m · frutificando", categoria: "grande", ambiente: "externo", pet: "safe",
    descricao: "Árvore em idade de produzir, suspensa ou apoiada. Muda o eixo de um hall inteiro — e dá fruta.", significado: "A jabuticabeira simboliza fartura, raízes e paciência — a árvore de quem valoriza o tempo.", preco: 2000, img: IMG("jabuticabeira-grande") },
  { id: "arvore-felicidade", nome: "Árvore da Felicidade", especie: "Polyscias sp. · fêmea e macho · 80 cm a 1 m", categoria: "grande", ambiente: "interno", pet: "toxic",
    descricao: "Sai em dois desenhos de folha: a fêmea, de folíolo largo e arredondado, e o macho, de folha recortada e fina. Tronco lenhoso e porte ereto — peça de canto e de entrada.", significado: "A árvore da felicidade — símbolo de boas energias, harmonia e alegria no lar.", preco: 2000, img: IMG("arvore-felicidade") },
  ...
  { id: "suporte-tripe-60", nome: "Tripé de ferro · 60 cm", especie: "Suporte de chão · ferro preto · aro 18 cm · altura 60 cm", categoria: "suporte", suporte: true,
    descricao: "O tripé mais alto, para as maxi kokedamas e peças de grande porte ganharem destaque de canto de sala.", preco: 150, imgs: ["assets/bases/tripe-60.jpg", "assets/bases/tripe-60-uso.jpg"] },
  ...
  { id: "suporte-cubo-ferro-baixo", nome: "Cubo de ferro · baixo", especie: "Suporte especial · ferro preto · aro interno", categoria: "suporte", suporte: true,
    descricao: "Estrutura vazada com aro suspenso no centro. A esfera flutua dentro do quadro, na altura do olhar sentado.", preco: 90, imgs: ["assets/bases/cubo-ferro-baixo.jpg", "assets/bases/cubo-ferro-baixo-uso.jpg"] },
  ...
  { id: "suporte-madeira-lisa", nome: "Madeira lisa", especie: "Suporte · madeira · 15 × 15 cm", categoria: "suporte", suporte: true,
    descricao: "Bloco de madeira com encaixe côncavo. A esfera assenta direto, sem haste — o apoio mais discreto de todos.", preco: 60, imgs: ["assets/bases/madeira-lisa.jpg", "assets/bases/madeira-lisa-uso.jpg"] },
  { id: "suporte-ferro-aro-base", nome: "Ferro · aro sobre base quadrada", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Aro de ferro preto suspenso sobre base quadrada. A esfera flutua acima do apoio, com ar de escultura.", preco: 50, imgs: ["assets/bases/ferro-aro-base.jpg", "assets/bases/ferro-aro-base-uso.jpg"] },
  { id: "suporte-ferro-esfera", nome: "Ferro · esfera de arame", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Esfera de arame de ferro preto. A kokedama se aninha entre as linhas curvas, num desenho escultórico.", preco: 50, imgs: ["assets/bases/ferro-esfera.jpg", "assets/bases/ferro-esfera-uso.jpg"] },
  { id: "suporte-ferro-cone", nome: "Ferro · cone", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Estrutura cônica de ferro preto, mais larga na base. Apoio estável e geométrico, ergue a esfera do móvel.", preco: 50, imgs: ["assets/bases/ferro-cone.jpg", "assets/bases/ferro-cone-uso.jpg"] },
  { id: "suporte-ferro-tripe-v", nome: "Ferro · tripé pés em V", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Tripé de ferro preto com pés finos em V e aro no topo. Leve e moderno, levanta a esfera do móvel.", preco: 50, imgs: ["assets/bases/ferro-tripe-v.jpg", "assets/bases/ferro-tripe-v-uso.jpg"] },
  { id: "suporte-ferro-cruzado", nome: "Ferro · aros cruzados", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Dois aros de ferro preto unidos por hastes que se cruzam na cintura. A esfera assenta no aro de cima, num jogo de linhas que lembra escultura.", preco: 50, imgs: ["assets/bases/ferro-cruzado.jpg", "assets/bases/ferro-cruzado-uso.jpg"] },
  { id: "suporte-ferro-dois-aros", nome: "Ferro · dois aros", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Dois aros de ferro preto ligados por uma haste reta, em dois níveis. Apoio simples e firme, ergue a esfera do móvel.", preco: 50, imgs: ["assets/bases/ferro-dois-aros.jpg", "assets/bases/ferro-dois-aros-uso.jpg"] },
  { id: "suporte-ferro-espiral", nome: "Ferro · espiral", especie: "Suporte · ferro preto", categoria: "suporte", suporte: true,
    descricao: "Uma única linha de ferro preto que sobe em espiral, do aro da base ao aro do topo. Movimento e leveza — a mais gráfica da linha.", preco: 50, imgs: ["assets/bases/ferro-espiral.jpg", "assets/bases/ferro-espiral-uso.jpg"] },
];

...
const PRODUCTS = [
  ...
  { id: "asplenio", nome: "Asplênio", peso: 3, especie: "Asplenium nidus", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folhas inteiras em roseta, brilhantes. Cresce como um ninho aberto sobre a esfera.", preco: 270, img: IMG("asplenio") },
  ...
  { id: "anturio-coracao", nome: "Antúrio Coração", especie: "Anthurium clarinervium", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas grandes em forma de coração, aveludadas e verde-escuras, com nervuras brancas bem marcadas. Uma folhagem de colecionador — pede luz indireta e umidade.", preco: 185, img: IMG("anturio-coracao") },
  ...
  { id: "rosa-do-deserto", nome: "Rosa do Deserto", especie: "Adenium obesum", categoria: "arlivre", ambiente: "externo", pet: "toxic",
    descricao: "Caudex escultural e floradas intensas, do rosa ao vermelho. Ama sol pleno — uma joia para varanda ensolarada.", preco: 120 },
  ...
  { id: "waxflower", nome: "Waxflower Australiana", especie: "Chamelaucium uncinatum", categoria: "arlivre", ambiente: "externo", pet: "safe",
    descricao: "Arbusto australiano de folhagem fina como agulhas, aromática, coberta por pequenas flores de cera. Adora sol pleno e ar livre — rústica e cheia de charme.", preco: 210, img: IMG("waxflower") },
  { id: "mini-jiboia", nome: "Mini Jiboia", especie: "Epipremnum aureum · mini", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "A jiboia em versão pequena, de folhas coração. Resistente e fácil de cuidar — cresce em cascata conforme se acostuma com o cantinho. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", preco: 130, variantes: [{ label: "Neon", preco: 130 }, { label: "Marmorizada", preco: 130 }, { label: "Jade", preco: 130 }, { label: "Prateada", preco: 130 }, { label: "Pérola", preco: 130 }], imgs: [IMG("mini-jiboia"), IMG("mini-jiboia-2"), IMG("mini-jiboia-3"), IMG("mini-jiboia-4"), IMG("mini-jiboia-5")] },
  ...
  { id: "maranta-triostar", nome: "Mini Maranta Triostar", especie: "Stromanthe sanguinea 'Triostar'", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Verde, creme e rosa na mesma folha, com verso inteiramente magenta. Levanta as folhas à noite e as baixa pela manhã.", preco: 125, img: IMG("maranta-triostar") },
  ...
  { id: "bonsai-amora-17", nome: "Bonsai Amora · 16 anos", especie: "Morus nigra · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos em meio metro. Tronco engrossado, casca fissurada, e fruta escura na estação — árvore que dá colheita numa mesa de sala.", preco: 1800, img: IMG("bonsai-amora-17") },
  ...
  { id: "bonsai-pinheiro-negro-14", nome: "Bonsai Pinheiro Negro · 14 anos", especie: "Pinus thunbergii · 40 a 60 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "A espécie mais reverenciada da tradição japonesa. Agulha rígida, casca em placas, silhueta construída agulha por agulha ao longo de catorze anos.", preco: 2800, img: IMG("bonsai-pinheiro-negro-14") },
  { id: "bonsai-shimpaku-16", nome: "Bonsai Shimpaku · 16 anos", especie: "Juniperus chinensis 'Shimpaku' · 30 a 40 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Junípero de folha escamosa e macia, madeira que aceita torção. O clássico dos jardins japoneses, em escala de mesa.", preco: 2000, img: IMG("bonsai-shimpaku-16") },
  { id: "bonsai-shimpaku-5", nome: "Bonsai Shimpaku · 4 anos", especie: "Juniperus chinensis 'Shimpaku' · aprox. 30 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Quatro anos de condução num tronco já curvado, de casca fina e folhagem escamosa verde-clara. O junípero clássico dos jardins japoneses, no ponto em que ainda se deixa moldar — para acompanhar a árvore ganhar forma.", preco: 750, img: IMG("bonsai-shimpaku-5") },
  ...
  { id: "bonsai-cambui-8", nome: "Bonsai Cambuí · 8 anos", especie: "Myrciaria tenella · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Nativa da mata atlântica, de folha minúscula e casca clara que descama sozinha. Dá frutinha vermelha comestível.", preco: 900, img: IMG("bonsai-cambui-8") },
  { id: "bonsai-azaleia-4", nome: "Bonsai Azaleia · 4 anos", especie: "Rhododendron simsii · aprox. 80 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Tronco fino e alto, conduzido em espiral ao longo de quatro anos. Na primavera a copa desaparece sob a floração — é isso que a peça vem entregar.", preco: 550, img: IMG("bonsai-azaleia-4") },
  ...
  { id: "pau-dagua-grande", nome: "Pau d'Água", especie: "Dracaena fragrans · 1,20 m a 1,50 m", categoria: "grande", ambiente: "interno", pet: "toxic",
    descricao: "Colunas de folha listrada, verticais e limpas, em escala de árvore. Resolve o vazio de um canto de sala sem pedir nada em troca.", preco: 1000, img: IMG("pau-dagua-grande") },

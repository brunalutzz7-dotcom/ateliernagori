...
const PRODUCTS = [
  ...
  { id: "philodendron-birkin", nome: "Philodendron Birkin", especie: "Philodendron 'Birkin'", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Riscos brancos finos, nenhuma folha igual à outra. Compacta e discreta.", preco: 250, img: IMG("philodendron-birkin") },
  ...
  { id: "jiboia-suspensa", nome: "Jiboia Suspensa", especie: "Epipremnum aureum · pendente", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas em coração, variegadas de verde e creme, que caem livres da esfera. Perfeita para prateleira alta ou suporte de gancho." , preco: 270, img: IMG("jiboia-suspensa") },
  ...
  { id: "costela-adao", nome: "Costela de Adão", peso: 3, especie: "Monstera deliciosa", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Folha recortada que ganha novos vãos a cada broto. Cresce rápido e pede espaço.", preco: 325, img: IMG("costela-adao") },
  ...
  { id: "pacova", nome: "Pacová", peso: 3, especie: "Philodendron martianum", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Folha inteira e grossa sobre pecíolo inflado. Forma limpa, quase escultórica.", preco: 265, img: IMG("pacova") },
  { id: "pachira-aquatica", nome: "Pachira Aquática", peso: 3, especie: "Pachira aquatica · árvore do dinheiro", categoria: "ambos", ambiente: "ambos", pet: "safe",
    descricao: "Tronco trançado à mão e folhas em leque no topo. Conhecida como árvore do dinheiro — dizem que atrai prosperidade, e é por isso que sai tanto como presente.", preco: 190, img: IMG("pachira-aquatica") },
  ...
  { id: "asplenio", nome: "Asplênio", peso: 3, especie: "Asplenium nidus", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folhas inteiras em roseta, brilhantes. Cresce como um ninho aberto sobre a esfera.", preco: 280, img: IMG("asplenio") },
  ...
  { id: "anturio-rosa", nome: "Antúrio Rosa", especie: "Anthurium andraeanum · tamanho médio", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Espata rosada e brilhante que dura semanas abertas, sobre folhagem verde-escura lustrosa. Floresce quase o ano todo em luz indireta.", preco: 245, img: IMG("anturio-rosa") },
  { id: "anturio-coracao", nome: "Antúrio Coração", especie: "Anthurium clarinervium", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhas grandes em forma de coração, aveludadas e verde-escuras, com nervuras brancas bem marcadas. Uma folhagem de colecionador — pede luz indireta e umidade.", preco: 230, img: IMG("anturio-coracao") },
  ...
  { id: "avenca", nome: "Avenca", especie: "Adiantum sp.", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Frondes delicadas de folíolos miúdos, verde vivo. Adora umidade — ótima em banheiro claro ou pertinho de outras plantas.", preco: 230, img: IMG("avenca") },
  ...
  { id: "jade", nome: "Jade", especie: "Crassula ovata", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Suculenta de folhas gordinhas e brilhantes. Símbolo de prosperidade, quase não pede água — só bastante luz.", preco: 190, img: IMG("jade") },
  { id: "croton", nome: "Croton", especie: "Codiaeum variegatum", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "Folha coriácea listrada de verde, amarelo e vermelho, que ganha cor quanto mais luz recebe. Nenhuma folha repete a mistura da outra.", preco: 190, img: IMG("croton") },
  ...
  { id: "rosa-do-deserto", nome: "Mini Rosa do Deserto", especie: "Adenium obesum · porte pequeno", categoria: "arlivre", ambiente: "externo", pet: "toxic",
    descricao: "Rosa do deserto em tamanho pequeno, de caudex já esculpido e floradas do rosa ao vermelho. Ama sol pleno — uma joia para varanda ensolarada.", preco: 190 },
  { id: "rosa-do-deserto-grande", nome: "Rosa do Deserto Grande", especie: "Adenium obesum · porte grande", categoria: "arlivre", ambiente: "externo", pet: "toxic",
    descricao: "Rosa do deserto em porte grande, de caudex desenvolvido e floradas intensas, do rosa ao vermelho. Ama sol pleno — uma joia de varanda ensolarada.", preco: 250 },
  ...
  { id: "waxflower", nome: "Waxflower Australiana", especie: "Chamelaucium uncinatum", categoria: "arlivre", ambiente: "externo", pet: "safe",
    descricao: "Arbusto australiano de folhagem fina como agulhas, aromática, coberta por pequenas flores de cera. Adora sol pleno e ar livre — rústica e cheia de charme.", preco: 230, img: IMG("waxflower") },
  { id: "mini-jiboia", nome: "Mini Jiboia", especie: "Epipremnum aureum · mini", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "A jiboia em versão pequena, de folhas coração. Resistente e fácil de cuidar — cresce em cascata conforme se acostuma com o cantinho. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", preco: 150, variantes: [{ label: "Neon", preco: 150 }, { label: "Marmorizada", preco: 150 }, { label: "Jade", preco: 150 }, { label: "Prateada", preco: 150 }, { label: "Pérola", preco: 150 }], imgs: [IMG("mini-jiboia"), IMG("mini-jiboia-2"), IMG("mini-jiboia-3"), IMG("mini-jiboia-4"), IMG("mini-jiboia-5")] },
  { id: "maranta-cascavel", nome: "Mini Maranta Cascavel", especie: "Goeppertia insignis", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folha estreita e ondulada, salpicada de manchas escuras alternadas — o nome vem do desenho, que lembra pele de cobra. O par montado junto fica especialmente bonito.", variantes: [{ label: "Peça única", preco: 150 }, { label: "O par", preco: 280 }], img: IMG("maranta-cascavel") },
  { id: "maranta-triostar", nome: "Mini Maranta Triostar", especie: "Stromanthe sanguinea 'Triostar'", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Verde, creme e rosa na mesma folha, com verso inteiramente magenta. Levanta as folhas à noite e as baixa pela manhã.", preco: 150, img: IMG("maranta-triostar") },
  { id: "maranta-burle-marx", nome: "Mini Maranta Burle Marx", especie: "Ctenanthe burle-marxii · aprox. 25 cm", categoria: "dentro", ambiente: "interno", pet: "safe",
    descricao: "Folha listrada em espinha de peixe, verde-claro sobre verde escuro, com o verso vinho. Fecha as folhas à noite e reabre pela manhã.", preco: 150, img: IMG("maranta-burle-marx") },
  { id: "mini-costela-adao", nome: "Mini Costela de Adão", especie: "Monstera deliciosa · mini", categoria: "ambos", ambiente: "ambos", pet: "toxic",
    descricao: "A costela de Adão em tamanho de mesa, com os recortes que todo mundo ama já começando a aparecer.", preco: 170, img: IMG("mini-costela-adao") },
  { id: "aspargo-alfinete", nome: "Mini Aspargo Alfinete", especie: "Asparagus densiflorus 'Sprengeri'", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "Hastes arqueadas cobertas de folículos finos como agulhas, verde vivo. Mais volumoso e rústico que o melindre.", preco: 125, img: IMG("aspargo-alfinete") },
  /* ---------- 04 · BONSAIS ---------- */
  { id: "bonsai-ligustro-15", nome: "Bonsai Ligustro · 15 anos", especie: "Ligustrum sinense · aprox. 50 cm", categoria: "bonsai", ambiente: "ambos", pet: "toxic",
    descricao: "Folhagem miúda e densa, tronco que engrossa rápido. Perdoa erro de rega — o bonsai mais generoso para quem está começando.", preco: 950, imgs: [IMG("bonsai-ligustro-15-2"), IMG("bonsai-ligustro-15")] },
  ...
  { id: "bonsai-ficus-6", nome: "Bonsai Fícus · 6 anos", especie: "Ficus microcarpa · aprox. 30 cm", categoria: "bonsai", ambiente: "interno", pet: "toxic",
    descricao: "Seis anos num fícus de raízes engrossadas que emergem da esfera como um pequeno tronco de várias pernas. Folha pequena, lustrosa e verde-escura, copa densa. O bonsai de interior mais generoso — aceita luz indireta e perdoa esquecimento.", preco: 800, img: IMG("bonsai-ficus-6") },
  { id: "bonsai-jabuticabeira-12", nome: "Bonsai Jabuticabeira · 16 anos", especie: "Plinia cauliflora · aprox. 50 cm · frutificando", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos de formação, e já frutifica. A jabuticaba nasce colada ao tronco, como na árvore inteira — só que em meio metro de altura.", preco: 2500, imgs: [IMG("bonsai-jabuticabeira-12-2"), IMG("bonsai-jabuticabeira-12-3"), IMG("bonsai-jabuticabeira-12-4")] },
  { id: "bonsai-jabuticabeira-4", nome: "Bonsai Jabuticabeira · 4 anos", especie: "Plinia cauliflora · aprox. 40 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Casca lisa e clara, folhagem miúda, estrutura ainda em desenho. A peça de quem quer acompanhar a árvore desde cedo.", preco: 800, img: IMG("bonsai-jabuticabeira-4") },
  { id: "bonsai-amora-17", nome: "Bonsai Amora · 16 anos", especie: "Morus nigra · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos em meio metro. Tronco engrossado, casca fissurada, e fruta escura na estação — árvore que dá colheita numa mesa de sala.", preco: 2000, img: IMG("bonsai-amora-17") },
  { id: "bonsai-amora-7", nome: "Bonsai Amora · 7 anos", especie: "Morus nigra · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Mesma altura da irmã mais velha, dez anos a menos de tronco. Cresce rápido e responde bem à poda — boa para quem quer aprender a conduzir.", preco: 800, img: IMG("bonsai-amora-7") },
  { id: "bonsai-oliveira-16", nome: "Bonsai Oliveira · 16 anos", especie: "Olea europaea · aprox. 40 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Dezesseis anos de condução em um tronco que já carrega casca rugosa e curva definida. Folha prateada que troca de tom conforme a luz atravessa o dia.", preco: 2500, img: IMG("bonsai-oliveira-16") },
  { id: "bonsai-pinheiro-negro-14", nome: "Bonsai Pinheiro Negro · 14 anos", especie: "Pinus thunbergii · 40 a 60 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "A espécie mais reverenciada da tradição japonesa. Agulha rígida, casca em placas, silhueta construída agulha por agulha ao longo de catorze anos.", preco: 3000, img: IMG("bonsai-pinheiro-negro-14") },
  { id: "bonsai-shimpaku-16", nome: "Bonsai Shimpaku · 16 anos", especie: "Juniperus chinensis 'Shimpaku' · 30 a 40 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Junípero de folha escamosa e macia, madeira que aceita torção. O clássico dos jardins japoneses, em escala de mesa.", preco: 2300, img: IMG("bonsai-shimpaku-16") },
  { id: "bonsai-shimpaku-5", nome: "Bonsai Shimpaku · 4 anos", especie: "Juniperus chinensis 'Shimpaku' · aprox. 30 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Quatro anos de condução num tronco já curvado, de casca fina e folhagem escamosa verde-clara. O junípero clássico dos jardins japoneses, no ponto em que ainda se deixa moldar — para acompanhar a árvore ganhar forma.", preco: 800, img: IMG("bonsai-shimpaku-5") },
  { id: "bonsai-sakura", nome: "Bonsai Sakura", especie: "Prunus serrulata · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "A cerejeira japonesa em vinte centímetros. Floresce antes de folhar, e a flor dura poucos dias — é a imagem exata de nagori.", preco: 990, img: IMG("bonsai-sakura") },
  { id: "bonsai-caliandra-9", nome: "Bonsai Caliandra Rosa · 9 anos", especie: "Calliandra brevipes · aprox. 50 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Tronco engrossado, casca rugosa e ramificação já aberta. Flor em pompom rosado quase o ano inteiro.", preco: 1000, img: IMG("bonsai-caliandra-9") },
  { id: "bonsai-caliandra-4", nome: "Bonsai Caliandra Rosa · 4 anos", especie: "Calliandra brevipes · 40 a 50 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Flor em pompom rosado sobre folhagem fina que se fecha ao anoitecer. Nativa, floresce quase o ano inteiro.", preco: 800, img: IMG("bonsai-caliandra-4") },
  ...
  { id: "bonsai-buxus-9", nome: "Bonsai Buxus · 9 anos", especie: "Buxus harlandii · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Folha pequena e coriácea, casca cortiçosa e clara. Aceita poda severa e mantém a forma por muito tempo.", preco: 900, img: IMG("bonsai-buxus-9") },
  ...
  { id: "bonsai-cambui-8", nome: "Bonsai Cambuí · 8 anos", especie: "Myrciaria tenella · aprox. 20 cm", categoria: "bonsai", ambiente: "externo", pet: "safe",
    descricao: "Nativa da mata atlântica, de folha minúscula e casca clara que descama sozinha. Dá frutinha vermelha comestível.", preco: 990, img: IMG("bonsai-cambui-8") },
  { id: "bonsai-azaleia-4", nome: "Bonsai Azaleia · 4 anos", especie: "Rhododendron simsii · aprox. 80 cm", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Tronco fino e alto, conduzido em espiral ao longo de quatro anos. Na primavera a copa desaparece sob a floração — é isso que a peça vem entregar.", preco: 600, img: IMG("bonsai-azaleia-4") },
  { id: "bonsai-pinheirinho-tuia-3", nome: "Bonsai Pinheirinho Tuia · 3 anos", especie: "Thuja sp. · aprox. 25 cm · musgo vivo", categoria: "bonsai", ambiente: "externo", pet: "toxic",
    descricao: "Conífera de folhagem macia verde-azulada, montada sobre esfera de musgo vivo. Três anos de formação num tronco esguio que já ramifica — o pinheirinho em miniatura, no ponto de começar a ganhar copa.", preco: 450, img: IMG("bonsai-pinheirinho-tuia-3") },
  ...
  { id: "oliveira-grande", nome: "Oliveira", especie: "Olea europaea · 1,60 m a 1,80 m", categoria: "grande", ambiente: "externo", pet: "safe",
    descricao: "Oliveira adulta sustentada por uma única esfera de musgo. Tronco e folha prateada em escala de árvore — peça de chão, para hall e canto de sala.", preco: 2500, img: IMG("oliveira-grande") },
  { id: "jabuticabeira-grande", nome: "Jabuticabeira", especie: "Plinia cauliflora · 1,20 m a 1,60 m · frutificando", categoria: "grande", ambiente: "externo", pet: "safe",
    descricao: "Árvore em idade de produzir, suspensa ou apoiada. Muda o eixo de um hall inteiro — e dá fruta.", preco: 2000, img: IMG("jabuticabeira-grande") },
  { id: "pau-dagua-grande", nome: "Pau d'Água", especie: "Dracaena fragrans · 1,20 m a 1,50 m", categoria: "grande", ambiente: "interno", pet: "toxic",
    descricao: "Colunas de folha listrada, verticais e limpas, em escala de árvore. Resolve o vazio de um canto de sala sem pedir nada em troca.", preco: 1500, img: IMG("pau-dagua-grande") },
  { id: "arvore-felicidade", nome: "Árvore da Felicidade", especie: "Polyscias sp. · fêmea e macho · 80 cm a 1 m", categoria: "grande", ambiente: "interno", pet: "toxic",
    descricao: "Sai em dois desenhos de folha: a fêmea, de folíolo largo e arredondado, e o macho, de folha recortada e fina. Tronco lenhoso e porte ereto — peça de canto e de entrada.", preco: 2000, img: IMG("arvore-felicidade") },

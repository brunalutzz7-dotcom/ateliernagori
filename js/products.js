...
const PRODUCTS = [
  ...
  { id: "mini-jiboia", nome: "Mini Jiboia", especie: "Epipremnum aureum · mini", categoria: "dentro", ambiente: "ambos", pet: "toxic",
    descricao: "A jiboia em versão pequena, de folhas coração. Resistente e fácil de cuidar — cresce em cascata conforme se acostuma com o cantinho. Disponível em variações de cor (neon, marmorizada, jade e prateada); consulte a disponibilidade do momento.", preco: 130, imgs: [IMG("mini-jiboia"), IMG("mini-jiboia-2"), IMG("mini-jiboia-3"), IMG("mini-jiboia-4"), IMG("mini-jiboia-5")] },

...
const PRODUCTS = [
  ...
  { id: "aglaonema", nome: "Aglaonema", especie: "Aglaonema sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Folhagem de cores vivas o ano todo, sem depender de flor — do vermelho ao rosa, branco e tricolor. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", significado: "Conhecida como planta da sorte: simboliza prosperidade e boas energias, atraindo fortuna para a casa.", variantes: [{ label: "Cherry", preco: 230 }, { label: "Vermelha", preco: 230 }, { label: "Rosa", preco: 230 }, { label: "Lima", preco: 230 }, { label: "Branca", preco: 230 }, { label: "Tricolor", preco: 230 }], imgs: [IMG("aglaonema-cherry"), IMG("aglaonema-vermelha"), IMG("aglaonema-branca-rosada"), IMG("aglaonema-rosa"), IMG("aglaonema-branca"), IMG("aglaonema-tricolor")] },
  ...
  { id: "ficus", nome: "Fícus", peso: 3, especie: "Ficus sp.", categoria: "dentro", ambiente: "interno", pet: "toxic",
    descricao: "Fícus nas suas variedades mais bonitas — da folha-de-lira (Lyrata) às borrachas variegadas Burgundy, Shivereana, Tineke e Ruby. Escolha a variedade abaixo (sujeito à disponibilidade do momento).", significado: "O fícus simboliza abundância, unidade e novos começos — árvore sagrada que atrai prosperidade e paz.", variantes: [{ label: "Elástica Shivereana", preco: 350 }, { label: "Lyrata", preco: 350 }, { label: "Elástica Burgundy", preco: 350 }, { label: "Elástica Tineke", preco: 350 }, { label: "Elástica Ruby", preco: 350 }], imgs: [IMG("ficus-shivereana"), IMG("ficus-lyrata"), IMG("ficus-burgundy"), IMG("ficus-tineke"), IMG("ficus-ruby")] },
